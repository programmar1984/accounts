...
Accept receipt images or PDFs on the new expense page, extract structured data via a local LM Studio vision model, and create a DRAFT expense with categorized lines and an attachment for human review before posting.
